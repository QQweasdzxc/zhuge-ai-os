...
- Runtime / Source Build: `20260810-0623`
...
```text
20260810_0623_ZhugeAIOS_v0.9.0-alpha.9.12_AI_Board_SharedShell_GPT_Review_Candidate.zip
20260810_0623_ZhugeAIOS_v0.9.0-alpha.9.12_AI_Board_SharedShell_Source.zip
```
