...
| --- | --- | --- |
| 00:00–00:40 | Public Homepage | Public access, stable Root URL, no automatic redirect |
| 00:40–01:05 | Privacy / Terms / Support | Public policies and support contact are visible |
| 01:05–01:50 | Continue with Google | Google Sign-In and consent screen |
| 01:50–02:20 | Authenticated Dashboard | Authenticated identity and available modules |
| 02:20–03:05 | WorkLog | Normal authenticated WorkLog usage |
| 03:05–03:40 | Knowledge Import entry | Drive permission is not requested until explicit Import action |
| 03:40–04:35 | Google Picker | User explicitly selects one demo file |
| 04:35–05:35 | Import and Knowledge result | Only the selected file is imported and processed |
| 05:35–06:10 | Return to WorkLog | Imported Knowledge is available to the user |
| 06:10–06:30 | Reviewer summary | No scanning, synchronization, crawling, or hidden collection |

## Narration Script

### 00:00–00:40 — Public Homepage
...
### 01:50–02:20 — Authenticated Dashboard
...
### 03:05–03:40 — Explicit Knowledge Import
...
### 04:35–05:35 — Import and Knowledge Result
...
### 06:10–06:30 — Final Reviewer Summary
