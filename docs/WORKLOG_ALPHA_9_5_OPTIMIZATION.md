# WorkLog v0.9.0-alpha.9.8 Optimization Record
...
- `0.9.0-alpha.9.8`: optional Step 3, historical month load retry, real summary bars, Conversation upsert fix, Investment SIT status synchronization.
