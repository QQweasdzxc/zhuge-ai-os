...
**PASS — ready for GPT Review.** This navigation hotfix is included in the new candidate build. The artifact timestamp and Runtime Build are `20260809-2041`; QJC PM QA is the next gate and this report does not mark any TASK done.
