...
test("AI Board Browser UI exposes PM-readable drawer status, free workspace movement, and navigation", async t => {
  ...
  assert.match(output, /collapsed-visible=worklog,tasks-new,procurement,investment,skyeye,library,sync,management,settings/);
  ...
  assert.match(output, /dashboard,worklog,tasks-new,procurement,investment,skyeye,library,sync,management,settings/);
