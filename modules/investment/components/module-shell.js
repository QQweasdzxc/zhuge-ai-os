(function (root, factory) {
  ...
  function render(state, dependencies = {}) {
    ...
    return `<div class="zhuge-module-shell investment-module-shell" data-investment-module-shell><div id="zhugeSharedNavigation" data-external-root="../../" data-active-workspace="investment"></div><div class="app investment-app">
      ...
      <div class="investment-layout">
        <nav class="investment-local-nav" aria-label="投資子功能導覽">${nav}</nav>
